...
class ChatGPTAPI: LLMClient, @unchecked Sendable {
    ...
    init(apiKey: String, model: String = "gpt-3.5-turbo", systemPrompt: String = "You are an expert Data Scientist interviewer, you will be given a question and then my interview answer to that question. Grade that response (A-F) and give feedback on my answer and provide a professional answer to the question.", temperature: Double = 0.5) {
        self.apiKey = apiKey
        self.model = model
